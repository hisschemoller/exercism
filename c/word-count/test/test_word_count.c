                           ...
                           int actual_word_count)
{
   ...
   //    printf("expected %i %i %s\n", i, expected_solution[i].count, expected_solution[i].text);
   // }
   // printf("expected_word_count %i\n", expected_word_count);
   // for (unsigned int i = 0; i < MAX_WORDS; i++) {
   //    printf("actual %i %i %s\n", i, actual_solution[i].count, actual_solution[i].text);
   // }
   // printf("actual_word_count %i\n", actual_word_count);
...
static void test_word_count_one_word(void)
{
   ...
   // for (unsigned int i = 0; i < MAX_WORDS; i++) {
   //    printf("TEST1 expected %i %i %s\n", i, expected_solution[i].count, expected_solution[i].text);
   // }
   // printf("TEST1 expected_word_count %i\n", expected_word_count);
